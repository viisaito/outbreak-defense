...
export class GameOverScene extends Scene {
  ...
  create() {
    ...
    const btnTentar = this.add.rectangle(285, 345, 210, 44, 0x2a0e0e)
      .setStrokeStyle(1, 0xff4444)
      .setInteractive({ useHandCursor: true });
    this.add.text(285, 345, 'TENTAR NOVAMENTE', {
    ...
    const btnMenu = this.add.rectangle(535, 345, 180, 44, 0x1a1a2e)
      .setStrokeStyle(1, 0x444466)
      .setInteractive({ useHandCursor: true });
    this.add.text(535, 345, 'MENU PRINCIPAL', {
    ...
    this.add.text(400, 415, 'Dica: posicione aliados em slots diferentes para cobrir mais area.', {
